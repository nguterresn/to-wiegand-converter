  ...
  <div class="container">
    ...
    <div class="row">
      <div class="seven columns">
        <select class="u-full-width" name="cars" id="cars">
      ...
      <div class="five columns">
        <!-- add in-line button  -->
        <button class="button-primary" type="button" id="button">Save</button>
      </div>
    </div>
    <hr>
    <div class="row">
...
<script>
  window.onload = function () {
    ...
    //   xhr.open('GET', "/open?lat=" + latitudeText + "&long=" + longitudeText, true);
    //   // send request
    //   xhr.send();
    // });
    ...
    //     // process response
    //     if (xhr.status == 200) {
    //       consoleLog.innerHTML = 200;
    //       alert("Geocache closed.");
    //     } else {
    //       consoleLog.innerText = "404";
    //     }
    //   };
